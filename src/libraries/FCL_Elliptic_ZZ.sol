...
/// @author Modified from FCL (https://github.com/rdubois-crypto/FreshCryptoLib/tree/master)
/// - Converted ecdsa_verify to external to use an external library
/// - Removed currently unused functions ecdsa_precomputed_hackmem & ecdsa_verify
